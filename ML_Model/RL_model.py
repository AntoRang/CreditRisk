...
dt_grid = GridSearchCV(DecisionTreeClassifier(random_state=42),dt_params, verbose=1,cv=2,n_jobs=8,scoring='accuracy')
dt_grid.fit(X_train, Y_train)

print(dt_grid.best_estimator_)

#Accuracy con 'Trainset'
dt = dt_grid.best_estimator_
array = np.array([2.67716444, 0.66994484, 1.67683077, -0.13364358, -0.70614255,  1.8910083, 0.75438593, -1.45490372])
print(dt.predict(array.reshape(1, -1)))
